class LocationsController < ApplicationController
  ...
  def new
    ...
    @cities = ["Atlanta","Sandy Springs","College Park","East Point","Hapeville","Decatur","Alpharetta","Doraville","Chamblee","Brookhaven","Tucker","Stone Mountain","Norcross","Duluth","Dunwoody","Roswell","John's Creek","Milton"].sort
  end
